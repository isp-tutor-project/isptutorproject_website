			...
			$.each(ajax_data, function(index, val) 
			{
				...
				tbl +='<tr row_id="'+row_id+'">';
					...
					tbl +='<td ><div class="row_data" col_name="userid">'+val['userid']+'</div></td>';
          			tbl +='<td ><div class="row_data" col_name="pretest">'+val['pretest']+'</div></td>';
          			tbl +='<td ><div class="row_data" col_name="tutor">'+val['tutor']+'</div></td>';
          			tbl +='<td ><div class="row_data" col_name="posttest">'+val['posttest']+'</div></td>';
